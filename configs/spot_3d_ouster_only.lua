...
options = {
  ...
  map_frame = "spot/map",
  tracking_frame = "spot/horiz_os1_imu",
  published_frame = "base_ouster_link",
...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight = 25  --default 5.  gene 3.  kyle 25
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.rotation_weight = 50 --default 4e2   gene 30 kyle 1.5e2 kyl2 50
...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.ceres_solver_options.num_threads = 2 --default 1     gene 6
...
TRAJECTORY_BUILDER_3D.submaps.high_resolution = 0.15  --default 0.10
...
TRAJECTORY_BUILDER_3D.submaps.num_range_data = 135  --default 160
...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.03 --default 0.3     gene 0.03
...
POSE_GRAPH.constraint_builder.ceres_scan_matcher_3d.ceres_solver_options.num_threads = 2  --default 1 gene 6
...
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 5 --default 50      gene 5
POSE_GRAPH.optimization_problem.ceres_solver_options.num_threads = 2  --default 7       gene 6
