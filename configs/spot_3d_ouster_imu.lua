...
options = {
  ...
  map_frame = "spot/map",
  tracking_frame = "spot/imu_viz_link",
  published_frame = "spot/imu_viz_link",
  odom_frame = "ouster/odom",
...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight = 25																--default 5.    gene 3.
...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.1                                              --default 0.3     gene 0.03
...
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 10                    --default 50      gene 5
POSE_GRAPH.optimization_problem.ceres_solver_options.num_threads = 6                            --default 7       gene 6
